...
| `reserved-confirmation-preparation-boundary` | full-data preparation and outcome-blind reserved-confirmation exclusion before freeze (`config/research_dataset.json`) | `scripts/checks/check_data_assurance_contract.py` | pre-ci+ci |
