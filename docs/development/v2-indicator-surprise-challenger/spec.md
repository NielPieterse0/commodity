...
- Carry-forward, staleness, and conservative reconstructed source-availability rules are governed by `config/data_sources.json` at preparation SHA-256 `63464479a32baf1e72980d19cd084c37007a3270b0b577a3b88dda175cbb3ba5`; this document does not independently own those numeric limits.
