...
# literature-anchored-research-lifecycle-v4
...
| --- | --- |
| `schema_version` | 4 |
| `methodology_id` | literature-anchored-research-lifecycle-v4 |
| `issue` | 320 |
| `supersedes_issue` | 300 |
...
| `confirmatory_preoutcome_assurance_method` | structural_identity_contract_v1 |
...
| `new_confirmatory_execution_requires` | array (9 items) |
| `confirmatory_result_acceptance_requires` | array (3 items) |
| `new_exploratory_execution_requires` | array (4 items) |
| `confirmatory_preoutcome_assurance_method` | str |
