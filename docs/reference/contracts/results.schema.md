...
| `properties` | object (17 keys) |

## Contract

Required fields: `schema_version`, `zoom_level`, `experiment_id`, `run_id`, `prereg_sha256`, `code`, `data`, `features`, `model`, `environment`, `raw_evidence`, `verification`, `method_compliance`, `scientific_evidence`, `coherence`, `family_inference`, `artifacts`
