<!-- GENERATED FILE. DO NOT EDIT. Source: research/programmes/002-henry-hub-fresh/lines/003-weather/line.json -->

# 002-henry-hub-fresh

Source: `research/programmes/002-henry-hub-fresh/lines/003-weather/line.json`
...
| `big_picture` | This line tests observed and issued weather mechanisms as part of the wider goal of understanding Henry Hub before prediction or model selection. |
| `why_zoomed_in` | Weather affects gas demand, but observed-weather reproduction and issued-forecast/revision research are different information sets and must not be silently substituted. |
