<!-- GENERATED FILE. DO NOT EDIT. Source: research/programmes/002-henry-hub-fresh/lines/001-market-structure/experiments/001-samuelson-maturity-volatility/pre-outcome-evidence.json -->

# Pre Outcome Evidence

Source: `research/programmes/002-henry-hub-fresh/lines/001-market-structure/experiments/001-samuelson-maturity-volatility/pre-outcome-evidence.json`
...
| `conclusion` | Outcome-blind liquidity and temporal-identity dry run qualifies 99,714 positive-volume contract-days across 210 exact contract clusters; settlement prices were not accessed. |
