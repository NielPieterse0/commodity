<!-- GENERATED FILE. DO NOT EDIT. Source: research/programmes/002-henry-hub-fresh/lines/007-positioning-announcements/line.json -->

# 002-henry-hub-fresh

Source: `research/programmes/002-henry-hub-fresh/lines/007-positioning-announcements/line.json`
...
| `research_line_id` | 007-positioning-announcements |
| `status` | active |
...
| `big_picture` | This line tests announcement anomalies, attention and positioning as part of the wider goal of understanding Henry Hub before prediction or model selection. |
| `why_zoomed_in` | Scheduled information events and trader positioning are secondary mechanisms that require correct publication timing and adequate event/effective information. |
