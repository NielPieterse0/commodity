...
**HISTORICAL NOTE.** The original research capture included point-in-time observations about repository/account visibility and unrelated private repositories. Those details were removed before public-repository preparation because they are stale, non-authoritative, and not needed to reproduce the commodity research conclusion.
