# Tasks: V2 Optimization Harness

- [x] Confirm live KIS authority, classification, scope, and required artifacts.
- [x] Map authoritative requirements into the bounded repository change without duplicating upstream authority.
- [x] Implement with affected tests/evidence.
