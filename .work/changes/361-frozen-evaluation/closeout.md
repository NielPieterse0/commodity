...
- Official Databento pricing checked on 2026-09-13 lists CME Globex MDP 3.0 Standard at `$199/month`, including live data and L0 OHLCV, definitions and statistics. That is the clean source-preserving route for frozen v1 if approved. No subscription was purchased. Replacing Databento with Saxo or another source would change the frozen scientific source contract and therefore requires a separately versioned challenger rather than a silent v1 substitution.
