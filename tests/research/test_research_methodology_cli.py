...
def test_build_results_cli_requires_exact_execution_gate_inputs() -> None:
    ...
    assert args.ledger.as_posix().endswith("research/programme/programme_inference_ledger.json")
    assert args.sealed_registry.as_posix().endswith("research/programme/sealed_windows.json")
