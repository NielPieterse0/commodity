...
def test_v2_contract_is_refrozen_and_fail_closed_pending_independent_88() -> None:
    contract = _contract()
    assert contract["status"] == "frozen_pending_independent_88_reaudit"
    ...
    assert gate["88"]["current_state"] == "reopened_pending_reaudit"
