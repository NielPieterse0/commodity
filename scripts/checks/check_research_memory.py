...
def main() -> int:
    try:
        ...
        decisions = validate("contracts/programme_decisions.schema.json", ROOT / "research/programme/programme-decisions.json")
        backlog = validate("contracts/research_backlog.schema.json", ROOT / "research/programme/research-backlog.json")
