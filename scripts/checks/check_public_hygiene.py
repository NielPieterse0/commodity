...
EXEMPT_LOCAL_PATHS = {
    Path("AGENTS.md"),
    Path("README.md"),
    Path("scripts/checks/check_public_hygiene.py"),
    # Exact hash-bound #285 historical evidence must remain byte-identical to its
    # original source, including the machine-local path recorded at execution time.
    Path("research/programmes/001-commodity-natural-gas/lines/008-next-defensible-edge/experiments/006-natural-gas-market-replication-285/result.json"),
    Path("docs/reference/research/programmes/001-commodity-natural-gas/lines/008-next-defensible-edge/experiments/006-natural-gas-market-replication-285/result.md"),
}
EXEMPT_PREFIXES: tuple[Path, ...] = ()
