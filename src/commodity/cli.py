...
def build_parser() -> argparse.ArgumentParser:
    ...
    methodology_ledger = REPO_ROOT / "research/programme/programme_inference_ledger.json"
    programme_evidence = REPO_ROOT / "research/programme/programme_evidence_map.json"
    sealed_registry = REPO_ROOT / "research/programme/sealed_windows.json"
    ...
    freeze_exp.add_argument("--programme-evidence", type=Path, default=programme_evidence)
    freeze_exp.add_argument("--sealed-registry", type=Path, default=sealed_registry)
    ...
    can_run.add_argument("--sealed-registry", type=Path, default=sealed_registry)
    ...
    open_sealed.add_argument("--sealed-registry", type=Path, default=sealed_registry)
    ...
    build_results_cmd.add_argument("--sealed-registry", type=Path, default=sealed_registry)
    build_results_cmd.add_argument("--programme-evidence", type=Path, default=programme_evidence)
