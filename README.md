...
- **V1 disposition:** the empirical V1 disposition is complete with bounded caveats, but programme issue #15 remains open/on hold pending #78 longitudinal-metrics reconciliation and post-#78 exact-head verification. This is not a predictive-edge or promotion claim; research promotion remains false because the admitted market evidence is evaluation-only and Phase D found no robust edge. V2 empirical activation remains blocked until #15 closes. The prepared closeout gate is recorded in [`v1-programme-closeout-preparation.json`](docs/development/v1-research-completion/v1-programme-closeout-preparation.json).
